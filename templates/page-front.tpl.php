...
<body class="<?php print $classes; ?>">
	...
	<div id="splash" class="homepage-splash">
		<div class="page-wrapper">
			<div id="header">
				...
				<div id="header-last" class="header-box">
					<div id="quick-contact"><strong>808.591.4940</strong></div>
			...
			<div id="feature">
				<div id="feature-homepage" class="feature">
					<a href="#" title="Home">
						<img src="/sites/all/themes/altres/images/splash/feature/feature-homepage.png" alt="Home" width="980" height="385" class="feature-img" />
					</a>
				</div> <!-- /#feature-homepage -->
				<div id="feature-industrial" class="feature">
					<a href="/industrial/things-we-do" title="Industrial">
						<img src="/sites/all/themes/altres/images/splash/feature/feature-industrial.png" alt="Industrial" width="980" height="385" class="feature-img" />
					</a>
				</div> <!-- /#feature-industrial -->
				<div id="feature-office" class="feature">
					<a href="/office/things-we-do" title="Office">
						<img src="/sites/all/themes/altres/images/splash/feature/feature-office.png" alt="Office" width="980" height="385" class="feature-img" />
					</a>
				</div> <!-- /#feature-office -->			
				<div id="feature-technical" class="feature">
					<a href="/technical/things-we-do" title="Technical">
						<img src="/sites/all/themes/altres/images/splash/feature/feature-technical.png" alt="Technical" width="980" height="385" class="feature-img" />
					</a>
				</div> <!-- /#feature-technical -->
				<div id="feature-medical" class="feature">
					<a href="/medical/things-we-do" title="Medical">
						<img src="/sites/all/themes/altres/images/splash/feature/feature-medical.png" alt="Medical" width="980" height="385" class="feature-img" />
					</a>
				</div> <!-- /#feature-medical -->			
			</div>	<!-- /#feature -->
		</div>	<!-- /.page-wrapper -->
			...
			<div id="primary-links" class="nav">
				<ul class="links">
					<li class="menu-230 first">
						<a href="#" id="industrial" title="Construction, general labor, special projects, warehouse, drivers, carpenters...">Industrial<span><br />Construction, general labor, special projects, warehouse, drivers, carpenters...</span></a>
					</li>
					<li class="menu-231">
						<a href="#" id="office" title="General office, customer service, administrative, data entry, assistants, word processors...">Office<span><br />General office, customer service, administrative, data entry, assistants, word processors...</span></a>
					</li>
					<li class="menu-232">
						<a href="#" id="technical" title="Engineers, CAD drafters, systems analysis and design, programmers, system administrators...">Technical<span><br />Engineers, CAD drafters, systems analysis and design, programmers, system administrators...</span></a>
					</li>
					<li class="menu-233 last">
						<a href="#" id="medical" title="RNs, CNAs, LPNs, MAs, NAs, ER Techs, Psych Techs...">Medical<span><br />RNs, CNAs, LPNs, MAs, NAs, ER Techs, Psych Techs...</span></a>
					</li>
				</ul>
